      ...
      <div className="container-width">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
          ...
          <div className="w-full lg:w-[35%] shrink-0">
            <div
              className="relative aspect-[4/3] rounded-[2rem] overflow-hidden border-[6px] border-white shadow-[0_15px_40px_rgba(0,0,0,0.08)] bg-[#f5f5f5] -rotate-1"
            >
              <img
            ...
            >
              <div className="flex gap-5 text-[#888]">
                <a href="#" className="hover:text-black transition-colors"><Instagram className="w-4.5 h-4.5" /></a>
                <a href="#" className="hover:text-black transition-colors"><Linkedin className="w-4.5 h-4.5" /></a>
                <a href="#" className="hover:text-black transition-colors"><XIcon /></a>
              </div>
              <div className="text-right">
                <h3 className="font-bold text-lg text-black leading-tight">Joris van Dijk</h3>
                <p className="text-[#888] text-sm font-medium">Hanzo Studio, Founder</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex-1 pt-2">
            <div className="mb-14 relative">
              {/* Smiley Icon */}
              <div className="absolute -top-10 -right-2 w-5 h-5 text-[#FF5500]">
              ...
              <p className="text-lg md:text-xl text-[#555] leading-relaxed font-medium max-w-2xl">
            ...
            {/* Experience Table */}
            <div className="space-y-0 border-l border-black/10 pl-8 md:pl-12">
              {experience.map((item, i) => (
                <motion.div
                  key={item.role + item.company}
                  {...slideDown}
                  transition={{ ...slideDown.transition, delay: 0.4 + i * 0.1 }}
                  className="grid grid-cols-3 py-6 border-b border-black/5 items-center last:border-0 group hover:bg-black/[0.02] transition-colors -ml-12 pl-12"
                >
                  <span className="font-bold text-black text-xs md:text-sm uppercase tracking-tight">{item.role}</span>
                  <span className="text-[#888] font-medium text-sm md:text-base">{item.company}</span>
                  <span className="text-[#888] font-medium text-sm md:text-base text-right">{item.years}</span>
                </motion.div>
              ))}
            </div>
          </div>
